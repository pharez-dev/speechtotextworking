    ...
    try {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.RECORD_AUDIO,
        {
          ...
          message:
            'This app needs audio permission to work, Allow audio recording',
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        {permission == 'granted' ? (<>     <Text>{status}</Text>
          <Button
            // loading={loading}
            mode={'outlined'}
            style={styles.btn}
          ...
          <View
            ...
            <Text>Output:</Text>
            <Text>{output}</Text>
          </View></>:<Text>Please allow microphone permissions to use this app</Text>}
      </View>
    );
  }
}
